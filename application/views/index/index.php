...
<?php
if($postList && is_array($postList)) { foreach ($postList as $lines) { ?>
  ...
  <tbody>
    ...
    <tr>
      <td colspan="6" align="left" valign="top">
        ...
        <?php if($lines['reply_content']) { ?>
        <div class="blue">管理员回复：<?php echo $lines['reply_content'], ' --[ ',$lines['reply_time'], ' ]'; ?></div>
        <?php } ?>
        <?php if($loginStatus) { ?>
